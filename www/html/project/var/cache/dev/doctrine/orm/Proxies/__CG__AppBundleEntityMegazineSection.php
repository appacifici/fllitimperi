 ...
 */
class MegazineSection extends \AppBundle\Entity\MegazineSection implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\MegazineSection' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\MegazineSection' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\MegazineSection' . "\0" . 'nameUrl', '' . "\0" . 'AppBundle\\Entity\\MegazineSection' . "\0" . 'img', 'dataArticle', '' . "\0" . 'AppBundle\\Entity\\MegazineSection' . "\0" . 'isactive'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MegazineSection $proxy) {
