...
class User extends \AppBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'isAdmin', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'lastDbId', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'surname', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'email', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'username', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'password', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'role', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'registerAt'];
        }
