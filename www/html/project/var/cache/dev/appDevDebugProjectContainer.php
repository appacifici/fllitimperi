...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getSncRedis_SncredisDoctrineQueryCacheService()
    {
        ...
        return $this->services['snc_redis.sncredisDoctrineQueryCache'] = new \Predis\Client(new \Predis\Connection\Parameters(array('replication' => false, 'read_write_timeout' => NULL, 'iterable_multibulk' => false, 'profile' => 'default', 'prefix' => NULL, 'service' => NULL, 'async_connect' => false, 'timeout' => 5, 'persistent' => false, 'exceptions' => true, 'logging' => true, 'alias' => 'sncredisDoctrineQueryCache', 'scheme' => 'tcp', 'host' => '192.168.1.74', 'port' => 6379, 'path' => 14, 'database' => 14, 'password' => NULL, 'weight' => NULL)), new \Predis\Configuration\Options(array('replication' => false, 'read_write_timeout' => NULL, 'iterable_multibulk' => false, 'profile' => $a, 'prefix' => NULL, 'service' => NULL, 'async_connect' => false, 'timeout' => 5, 'persistent' => false, 'exceptions' => true, 'connections' => $b)));
    }
    ...
    protected function getSncRedis_SncredisDoctrineResultService()
    {
        ...
        return $this->services['snc_redis.sncredisDoctrineResult'] = new \Predis\Client(new \Predis\Connection\Parameters(array('replication' => false, 'read_write_timeout' => NULL, 'iterable_multibulk' => false, 'profile' => 'default', 'prefix' => NULL, 'service' => NULL, 'async_connect' => false, 'timeout' => 5, 'persistent' => false, 'exceptions' => true, 'logging' => true, 'alias' => 'sncredisDoctrineResult', 'scheme' => 'tcp', 'host' => '192.168.1.74', 'port' => 6379, 'path' => 13, 'database' => 13, 'password' => NULL, 'weight' => NULL)), new \Predis\Configuration\Options(array('replication' => false, 'read_write_timeout' => NULL, 'iterable_multibulk' => false, 'profile' => $a, 'prefix' => NULL, 'service' => NULL, 'async_connect' => false, 'timeout' => 5, 'persistent' => false, 'exceptions' => true, 'connections' => $b)));
    }
    ...
    protected function getSncRedis_SncredisDoctrinemetadataService()
    {
        ...
        return $this->services['snc_redis.sncredisDoctrinemetadata'] = new \Predis\Client(new \Predis\Connection\Parameters(array('replication' => false, 'read_write_timeout' => NULL, 'iterable_multibulk' => false, 'profile' => 'default', 'prefix' => NULL, 'service' => NULL, 'async_connect' => false, 'timeout' => 5, 'persistent' => false, 'exceptions' => true, 'logging' => true, 'alias' => 'sncredisDoctrinemetadata', 'scheme' => 'tcp', 'host' => '192.168.1.74', 'port' => 6379, 'path' => 12, 'database' => 12, 'password' => NULL, 'weight' => NULL)), new \Predis\Configuration\Options(array('replication' => false, 'read_write_timeout' => NULL, 'iterable_multibulk' => false, 'profile' => $a, 'prefix' => NULL, 'service' => NULL, 'async_connect' => false, 'timeout' => 5, 'persistent' => false, 'exceptions' => true, 'connections' => $b)));
    }
    ...
    protected function getSncRedis_SncredisSessionPhpService()
    {
        ...
        return $this->services['snc_redis.sncredisSessionPhp'] = new \Predis\Client(new \Predis\Connection\Parameters(array('read_write_timeout' => NULL, 'iterable_multibulk' => false, 'profile' => 'default', 'prefix' => NULL, 'service' => NULL, 'async_connect' => false, 'timeout' => 5, 'persistent' => false, 'exceptions' => true, 'logging' => true, 'alias' => 'sncredisSessionPhp', 'scheme' => 'tcp', 'host' => '192.168.1.74', 'port' => 6379, 'path' => 16, 'database' => 16, 'password' => NULL, 'weight' => NULL)), new \Predis\Configuration\Options(array('read_write_timeout' => NULL, 'iterable_multibulk' => false, 'profile' => $a, 'prefix' => NULL, 'service' => NULL, 'async_connect' => false, 'timeout' => 5, 'persistent' => false, 'exceptions' => true, 'connections' => $b)));
    }
    ...
    {
        return $this->services['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('0YAxbuPQQQ', 0, 'T2scoH+XgpFs7yqlDlMxo7', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ej-Tfa2gkW', 0, 'T2scoH+XgpFs7yqlDlMxo7', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('VilFa2DG-O', 0, 'T2scoH+XgpFs7yqlDlMxo7', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['security.authentication.provider.anonymous.main'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('64f8e827462b19.08152800');
    }
