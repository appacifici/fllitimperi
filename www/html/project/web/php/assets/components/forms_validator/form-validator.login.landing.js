formValidatorLoginLanding = null;
$( function() {
    formValidatorLoginLanding = new FormValidatorLoginLanding();
});

/**
 * Classe per delle notyfy
 */ 
var FormValidatorLoginLanding = function() {	
    this.initValidate( 'formLoginLanding' ); 
}


FormValidatorLoginLanding.prototype.initValidate = function( idFormLogin, reload, callback ) {
