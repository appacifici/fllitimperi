( function( $ ) {
	...
	if ( $.fn.dropzone != 'undefined' ) {
		$( '.dropzone' ).dropzone( {
            ...
            addRemoveLinks: true,
            uploadprogress: true,
            maxFilesize: allowedImageWeight,
            ...
            removedfile: function( file ) {                
                ...
                var request = $.ajax({
                    url: ajaxCallPath+"call.php?action=removeUserImage&id=" + id,
                    type: "GET",
                    dataType: "json"
                    ...
                    if( response.code == 501 ) {
                        ...
                        parameters['mex'] = 'Attenzione: cancellazione immagine non riuscita, riprovare e se il problema persiste contattare info@eroticland.it';
