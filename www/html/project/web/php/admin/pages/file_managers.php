...
<div id="dropzone">
	<form action="../assets/assets/upload.php" class="dropzone" id="demo-upload">
		<div class="fallback">
			...
			<p class="lead">This is just a demo dropzone. Uploaded files are <strong>not</strong> processed, BUT there is a Simple PHP Upload Example available in <code>components/forms/file_manager/dropzone/assets/lib/dropzone-upload-sample.php</code></p>
			<!-- // Dropzone END -->
