<div class="innerLR">
	...
	<h3 class="separator bottom">Range Sliders</h3>
		...
		<div class="col-md-6">
			...
			<div class="widget widget-heading-simple widget-body-gray">
				...
				<div class="widget-head">
					<h4 class="heading glyphicons adjust_alt"><i></i>Basic Range Slider</h4>
				</div>
				<!-- // Widget heading END -->
				
				<div class="widget-body"><!-- Slider -->
...
<!-- // Slider END -->
		...
		<div class="col-md-6">
			...
			<div class="widget widget-heading-simple widget-body-gray">
				...
				<!-- Widget heading -->
				<div class="widget-head">
					<h4 class="heading glyphicons adjust_alt"><i></i>Edit Range Slider</h4>
				</div>
				<!-- // Widget heading END -->
	...
	<div class="row">
		<div class="col-md-6">
			...
			<div class="widget widget-heading-simple widget-body-white">
				...
				<!-- Widget heading -->
				<div class="widget-head">
					<h4 class="heading glyphicons adjust_alt"><i></i>Date Range Slider</h4>
				</div>
				<!-- // Widget heading END -->
...
<!-- // Slider END -->
		...
		<div class="col-md-6">
			...
			<div class="widget widget-heading-simple widget-body-white">
				...
				<!-- Widget heading -->
				<div class="widget-head">
					<h4 class="heading glyphicons adjust_alt"><i></i>Range Slider without Arrows</h4>
				</div>
				<!-- // Widget heading END -->
	...
	<div class="row">
		<div class="col-md-6">
			...
			<div class="widget widget-heading-simple widget-body-gray">
				...
				<!-- Widget heading -->
				<div class="widget-head">
					<h4 class="heading glyphicons adjust_alt"><i></i>Range Slider with formatter</h4>
				</div>
				<!-- // Widget heading END -->
...
<!-- // Slider END -->
		...
		<div class="col-md-6">
			...
			<div class="widget widget-heading-simple widget-body-gray">
				...
				<!-- Widget heading -->
				<div class="widget-head">
					<h4 class="heading glyphicons adjust_alt"><i></i>Range Slider Rulers</h4>
				</div>
				<!-- // Widget heading END -->
...
<!-- // Slider END -->
	...
	<div class="widget widget-heading-simple widget-body-white">
		...
		<!-- Widget heading -->
		<div class="widget-head">
			<h4 class="heading glyphicons adjust_alt"><i></i>Date Range Slider Ruler</h4>
		</div>
		<!-- // Widget heading END -->
...
<!-- // Slider END -->
	...
	<div class="widget widget-heading-simple widget-body-gray">
		...
		<!-- Widget heading -->
		<div class="widget-head">
			<h4 class="heading glyphicons adjust_alt"><i></i>Range Slider Step</h4>
		</div>
		<!-- // Widget heading END -->
	...
	<div class="row">
		<div class="col-md-6">
			...
			<div class="widget widget-heading-simple widget-body-white">
				...
				<!-- Widget heading -->
				<div class="widget-head">
					<h4 class="heading glyphicons adjust_alt"><i></i>Range Slider Wheel Zoom</h4>
				</div>
				<!-- // Widget heading END -->
...
<!-- // Slider END -->
		...
		<div class="col-md-6">
			...
			<div class="widget widget-heading-simple widget-body-white">
				...
				<!-- Widget heading -->
				<div class="widget-head">
					<h4 class="heading glyphicons adjust_alt"><i></i>Range Slider Wheel Scroll</h4>
				</div>
				<!-- // Widget heading END -->
...
<!-- // Slider END -->
	...
	<!-- Sliders -->
	<h3 class="separator bottom">JQueryUI Sliders</h3>
	...
	<div class="widget widget-heading-simple widget-body-gray">
		...
		<!-- Widget heading -->
		<div class="widget-head">
			<h4 class="heading">Simple Slider</h4>
		</div>
		<!-- // Widget heading END -->
