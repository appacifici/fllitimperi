<div class="innerLR">
	...
	<div class="row">
		...
		<div class="col-lg-4 col-md-6">
			...
			<!-- BALLANCE START -->
<div class="widget ">
    <div class="widget-head"><h4 class="heading strong pull-left">Ballance</h4> <iclass="fa fa-euro text-primary pull-right innerT half"></i></div>
    <div class="widget-body">
        <div class="media">
            ...
            <div class="media-body">
                ...
                <p class="lead"><span class="text-primary">Current balance</span> this billing cycle</p></div>
        </div>
    </div>
</div>
<!-- // END BALLANCE -->
            ...
            <!-- STATISTIC START -->
<div class="widget">
    <div class="widget-head"><h5 class="heading strong pull-left"> Statistic</h5><i class="fa fa-bar-chart-o text-primary pull-right innerT half"></i></div>
    <div class="widget-body">
        <div class="innerAll text-center">
            <div data-percent="22" data-size="150" class="easy-pie inline-block easy-pie-gender inverse" data-scale-color="false" data-track-color="#ffffff" data-line-width="5">
                <div class="value text-center innerAll"><p class="lead text-large">22%</p></div>
            </div>
            <div class="separator bottom"></div>
            <p class="lead"><span class="text-large text-regular">8,320</span> of <span class="text-primary">your customers</span>
            </p>
            <p class="margin-none">living in <span class="strong">Caracal</span>, aged <span class="strong">50+</span>
            </p>
            <p class="margin-none">suffer from a <span class="strong text-primary">Heart Disease</span></p></div>
    </div>
</div>
<!-- // END STATISTIC -->
...
<div class="widget widget-body-white">
    <div class="widget-head"><h4 class="heading pull-left">By Gender</h4>
        <i class="fa fa-group text-primary pull-right innerT half"></i>
    </div>
    <div class="widget-body">
        <div class="innerAll text-center">
            <div data-percent="50" data-size="200" class="easy-pie inline-block easy-pie-gender" data-scale-color="false" data-track-color="#D67FB0" data-bar-color="#4193d0" data-line-width="8" data-animate="false">
                <div class="value text-center innerAll"><p class="lead">Your customers</p>
                    <p class="sublead">Male: <strong class="male">50%</strong></p>
                    <p class="sublead">Female: <strong class="female">50%</strong></p></div>
            </div>
...
<div class="widget widget-body-gray">
    <div class="widget-head"><h4 class="heading pull-left">Comparison</h4>
        <i class="fa fa-bar-chart-o text-primary pull-right innerT half"></i>
    </div>
    <div class="widget-body padding-none">
        <div class="innerAll text-center"><p class="lead"><span class="text-large text-regular">1,210</span> of <span class="text-primary">your customers</span></p>
            <div class="progress white progress-mini ">
                <div class="progress-bar progress-bar-primary" style="width: 30%"></div>
            </div>
            <p class="margin-none">living in <span class="strong">Bucharest</span>, aged <span class="strong">45+</span> </p>

            <p class="margin-none">suffer from a <span class="strong text-danger">deadly disease</span></p>
        </div>
    </div>
</div>
<!-- // END COMPARISON -->
...
<div class="widget widget-body-white">
    <div class="widget-head">
        <h4 class="heading pull-left">Male</h4>
        <i class="fa fa-bar-chart-o text-primary pull-right innerT half"></i>
    </div>
    <div class="widget-body">
        <i class="fa fa-male fa-fw text-male"></i><i class="fa fa-male fa-fw text-male"></i><i class="fa fa-male fa-fw text-male"></i><i class="fa fa-male fa-fw text-male"></i><i class="fa fa-male fa-fw text-male"></i><i class="fa fa-male fa-fw text-male"></i><i class="fa fa-male fa-fw text-male"></i><i class="fa fa-male fa-fw text-male"></i><i class="fa fa-male fa-fw text-male"></i><i class="fa fa-male fa-fw text-male"></i><i class="fa fa-male fa-fw text-male"></i><i class="fa fa-male fa-fw text-male"></i><i class="fa fa-male fa-fw text-male"></i><i class="fa fa-male fa-fw text-male"></i><i class="fa fa-male fa-fw text-male"></i><i class="fa fa-male fa-fw text-male"></i><i class="fa fa-male fa-fw text-male"></i><i class="fa fa-male fa-fw text-male"></i><i class="fa fa-male fa-fw text-male"></i><i class="fa fa-male fa-fw text-male"></i><i class="fa fa-male fa-fw text-male"></i><i class="fa fa-male fa-fw text-male"></i><i class="fa fa-male fa-fw text-male"></i><i class="fa fa-male fa-fw text-male"></i><i class="fa fa-male fa-fw text-male"></i><i class="fa fa-male fa-fw text-male"></i><i class="fa fa-male fa-fw text-male"></i><i class="fa fa-male fa-fw text-male"></i><i class="fa fa-male fa-fw text-male"></i><i class="fa fa-male fa-fw text-male"></i><i class="fa fa-male fa-fw text-male"></i><i class="fa fa-male fa-fw text-male"></i><i class="fa fa-male fa-fw text-male"></i><i class="fa fa-male fa-fw text-male"></i><i class="fa fa-male fa-fw text-male"></i><i class="fa fa-male fa-fw text-male"></i><i class="fa fa-male fa-fw text-male"></i><i class="fa fa-male fa-fw text-male"></i><i class="fa fa-male fa-fw text-male"></i><i class="fa fa-male fa-fw text-male"></i><i class="fa fa-male fa-fw text-male"></i><i class="fa fa-male fa-fw text-male"></i><i class="fa fa-male fa-fw text-male"></i><i class="fa fa-male fa-fw text-male"></i><i class="fa fa-male fa-fw text-male"></i><i class="fa fa-male fa-fw text-male-light"></i><i class="fa fa-male fa-fw text-male-light"></i><i class="fa fa-male fa-fw text-male-light"></i><i class="fa fa-male fa-fw text-male-light"></i><i class="fa fa-male fa-fw text-male-light"></i><i class="fa fa-male fa-fw text-male-light"></i><i class="fa fa-male fa-fw text-male-light"></i><i class="fa fa-male fa-fw text-male-light"></i><i class="fa fa-male fa-fw text-male-light"></i><i class="fa fa-male fa-fw text-male-light"></i><i class="fa fa-male fa-fw text-male-light"></i><i class="fa fa-male fa-fw text-male-light"></i><i class="fa fa-male fa-fw text-male-light"></i><i class="fa fa-male fa-fw text-male-light"></i><i class="fa fa-male fa-fw text-male-light"></i><i class="fa fa-male fa-fw text-male-light"></i><i class="fa fa-male fa-fw text-male-light"></i><i class="fa fa-male fa-fw text-male-light"></i><i class="fa fa-male fa-fw text-male-light"></i><i class="fa fa-male fa-fw text-male-light"></i><i class="fa fa-male fa-fw text-male-light"></i><i class="fa fa-male fa-fw text-male-light"></i><i class="fa fa-male fa-fw text-male-light"></i><i class="fa fa-male fa-fw text-male-light"></i><i class="fa fa-male fa-fw text-male-light"></i><i class="fa fa-male fa-fw text-male-light"></i><i class="fa fa-male fa-fw text-male-light"></i><i class="fa fa-male fa-fw text-male-light"></i><i class="fa fa-male fa-fw text-male-light"></i><i class="fa fa-male fa-fw text-male-light"></i><i class="fa fa-male fa-fw text-male-light"></i><i class="fa fa-male fa-fw text-male-light"></i><i class="fa fa-male fa-fw text-male-light"></i><i class="fa fa-male fa-fw text-male-light"></i><i class="fa fa-male fa-fw text-male-light"></i><i class="fa fa-male fa-fw text-male-light"></i><i class="fa fa-male fa-fw text-male-light"></i><i class="fa fa-male fa-fw text-male-light"></i><i class="fa fa-male fa-fw text-male-light"></i><i class="fa fa-male fa-fw text-male-light"></i><i class="fa fa-male fa-fw text-male-light"></i><i class="fa fa-male fa-fw text-male-light"></i><i class="fa fa-male fa-fw text-male-light"></i><i class="fa fa-male fa-fw text-male-light"></i><i class="fa fa-male fa-fw text-male-light"></i><i class="fa fa-male fa-fw text-male-light"></i><i class="fa fa-male fa-fw text-male-light"></i><i class="fa fa-male fa-fw text-male-light"></i><i class="fa fa-male fa-fw text-male-light"></i><i class="fa fa-male fa-fw text-male-light"></i><i class="fa fa-male fa-fw text-male-light"></i><i class="fa fa-male fa-fw text-male-light"></i><i class="fa fa-male fa-fw text-male-light"></i><i class="fa fa-male fa-fw text-male-light"></i><i class="fa fa-male fa-fw text-male-light"></i>        <div class="innerAll text-center">
