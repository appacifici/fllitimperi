...
<div class="innerLR">
	<div class="row">
		<div class="col-md-6"><div id="carousel-1" class="carousel slide">
	...
	<!-- // Navigation END -->
		...
		<div class="col-md-6"><div class="carousel carousel-1 slide" id="myCarousel">
	<div class="carousel-inner">
				<!-- Item -->
		<div class="item">
			<div class="row">
				<div class="col-xs-5 relativeWrap">
					<div class="carousel-caption">
						...
						<p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut.<br/> <a href="" class="separator top" target="_blank">Buy Social Admin Template!</a></p>
					</div>
				</div>
				<div class="col-xs-7">
