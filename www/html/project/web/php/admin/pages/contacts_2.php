<div class="innerAll">
	...
	<div class="cover image ">
		...
		<ul class="list-unstyled">
			...
			<li ><a href="<?php echo getURL(array('page'=>'media_2')); ?>"><i class="icon-photo-camera"></i> <span>Photos</span> <small>(102)</small></a></li>
			<li  class="active"><a href="<?php echo getURL(array('page'=>'contacts_2')); ?>"><i class="icon-group"></i> <span>Friends</span> <small>(19)</small></a></li>
			...
			<div class="col-sm-9">
				<div class="media">
					...
					<div class="media-body innerAll inner-2x padding-right-none padding-bottom-none">
						 ...
						 <p>
						 	<!-- <span class="text-success strong"><i class="fa fa-check"></i> Friend</span> &nbsp;  -->
						 	<i class="fa fa-fw fa-map-marker text-muted"></i> Living in Massachusetts, USA</p> 
					</div>
				</div>
			</div>
			<div class="col-sm-3">
			...
			<div class="col-sm-9">
				<div class="media">
					...
					<div class="media-body innerAll inner-2x padding-right-none padding-bottom-none">
						 ...
						 <p>
						 	<!-- <span class="text-success strong"><i class="fa fa-check"></i> Friend</span> &nbsp;  -->
						 	<i class="fa fa-fw fa-map-marker text-muted"></i> Living in Kentucky, USA</p> 
					</div>
				</div>
			</div>
			<div class="col-sm-3">
			...
			<div class="col-sm-9">
				<div class="media">
					...
					<div class="media-body innerAll inner-2x padding-right-none padding-bottom-none">
						 ...
						 <p>
						 	<!-- <span class="text-success strong"><i class="fa fa-check"></i> Friend</span> &nbsp;  -->
						 	<i class="fa fa-fw fa-map-marker text-muted"></i> Living in Pennsylvania, USA</p> 
					</div>
				</div>
			</div>
			<div class="col-sm-3">
			...
			<div class="col-sm-9">
				<div class="media">
					...
					<div class="media-body innerAll inner-2x padding-right-none padding-bottom-none">
						 ...
						 <p>
						 	<!-- <span class="text-success strong"><i class="fa fa-check"></i> Friend</span> &nbsp;  -->
						 	<i class="fa fa-fw fa-map-marker text-muted"></i> Living in California, USA</p> 
					</div>
				</div>
			</div>
			<div class="col-sm-3">
