...
use AppBundle\Service\WidgetService\WidgetManager;
...
class PaginationUtility {
    ...
    Container $container, RequestStack $requestStack, WidgetManager $widgetManager
    ) {
...
//	  $cur--;
    ...
    public function makeList() {
        ...
        if ($this->notLink) {
            ...
            if($this->currentPage > 1  && $this->totalPages > 10 ) {     
                ...
                $retval .= '<li class="step1 backOnePage disabled">&laquo;</li>';
            }
        }
        ...
        if ($this->notLink) {
            ...
            if ($this->currentPage > 1 ) {
                $retval .= '<li class="backOnePage active"><a href="' . str_replace('%i', ($this->currentPage - 1), $this->linkStructure) . '" title="Vai alla pagina precedente">&lt;<br>Precedente</a></li>';
            } else {
                $retval .= '<li class="backOnePage disabled">&lt;</li>';
            }
        }
        ...
        if ($this->notLink) {
            ...
            if ($this->currentPage < $this->totalPages && $this->totalPages > 10 ) {
                ...
                $retval .= '<li class="step2 nextOnePage disabled">&raquo;</li>';
            }
        }
        ...
        if ($this->notLink) {
            ...
            if ($this->currentPage < $this->totalPages) {
                $retval .='<li class="nextOnePage active"><a href="' . str_replace('%i', ($nextOnePage), $this->linkStructure) . '"  title="Vai alla pagina successiva">&gt;<br>Successiva</a></li>';
            } else {
                $retval .= '<li class="nextOnePage disabled">&gt;</li>';
            }
        }
    ...
    public function setNextPrevpage() {                
        ...
        if(  (int)$this->wm->getPage() > 1 ) {            
            $this->wm->container->get('twig')->addGlobal( 'canonicalUrl', str_replace( '/amp/', '/', $urlBasePrevNext ). '?page=' .(int) $this->wm->getPage());
            $this->wm->container->get('twig')->addGlobal( 'robots', 'index,follow' );
        }
    }  
}
