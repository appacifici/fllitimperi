...
class CoreAdminListDisabledModels {
    /**
    ...
    public function processData( $options = false ) {
        ...
        $models = $this->wm->doctrine->getRepository('AppBundle:DisabledModel')->findModelsWithLimit( $pagination->getLimit(), $name, $isCompleted, $category, $subcategory, $typology, $inShowcase, $revisioned, $date, $top );
        $countModels = $this->wm->doctrine->getRepository('AppBundle:DisabledModel')->countModels( $name, $isCompleted, $category, $subcategory, $typology, $inShowcase, $revisioned, $date, $top );
