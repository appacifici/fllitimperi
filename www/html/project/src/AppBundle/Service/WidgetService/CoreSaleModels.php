...
//                return array();
            ...
            $models = $this->wm->doctrine->getRepository('AppBundle:Model')->findBestDiscountedModels( false, 1, false, false, $limitNews );
            if( empty( $models ) ) {            
                return array();
            }
            ...
            $models = $this->wm->doctrine->getRepository('AppBundle:Model')->findBestDiscountedModels( $limitNews, $category, $subcategory, $typology, $trademark, $affiliate );
            if( empty( $models ) ) {            
                return array();
            }
...
//                continue;
            ...
            $model->setLastPrice( $this->wm->setPrice( $model->getLastPrice() ) );
            $finalModel[] = $model;
            $i++;
        }
