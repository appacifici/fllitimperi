...
class BonPrixAffiliation extends Affiliations {
...
//		$this->product->fkTrademark = $this->getTrademark( $this->product->brand );
	...
	public function mapFields() {
        ...
        $this->product->sizeStockStatus     = !empty( $this->product->availability ) ? $this->product->availability : 'NULL';
...
//		}
        ...
        $this->product->gender = '';
		if ( !empty( $this->product->fields->gender ) ) {
			$this->product->sex = $this->product->fields->gender;
		}
	...
	private function insertBridgeData() {
		$this->product->colors = !empty( $this->product->fields->colour ) ? $this->product->fields->colour : false;
		$this->product->sizes = !empty( $this->product->size ) ? $this->product->size : false;		
	}
