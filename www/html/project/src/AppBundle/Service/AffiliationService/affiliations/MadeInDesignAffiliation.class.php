...
class MadeInDesignAffiliation extends Affiliations {
    ...
    public function mapFields() {
		...
		$this->product->shippingHandlingCost = isset( $this->product->shippingHandlingCosts ) ? $this->product->shippingHandlingCosts : 0;
