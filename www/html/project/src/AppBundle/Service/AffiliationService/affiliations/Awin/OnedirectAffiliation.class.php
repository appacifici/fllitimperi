...
class OnedirectAffiliation extends Affiliations {
...
//		$this->product->fkTrademark = $this->getTrademark( $this->product->brand );
	...
	public function mapFields() {
		...
		$this->product->stockAmount = !empty( $this->product->in_stock )  ? $this->product->in_stock : null;
        ...
        if( !empty( $this->product->in_stock ) && $this->product->in_stock > 0 ) {
