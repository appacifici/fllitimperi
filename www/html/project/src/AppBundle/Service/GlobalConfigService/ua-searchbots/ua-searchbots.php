...
// Get the hostname
$domainName = !empty( $_SERVER["SERVER_NAME"] ) ? $_SERVER["SERVER_NAME"] : '';
if ($domainName != '') {
  $uaParams['dh'] = $domainName;
}

// Get the URI of the page
$documentPath = !empty( $_SERVER["REQUEST_URI"] ) ? $_SERVER["REQUEST_URI"] : false;
...
$documentReferer = !empty( $_SERVER["HTTP_REFERER"] ) ? $_SERVER["HTTP_REFERER"] : false;
